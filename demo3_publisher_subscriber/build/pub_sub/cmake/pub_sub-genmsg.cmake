...
set(MSG_I_FLAGS "-Ipub_sub:/datav/projects/ROS/demo3_publisher_subscriber/src/pub_sub/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/datav/projects/ROS/demo3_publisher_subscriber/src/pub_sub/msg/Spacecraft.msg" NAME_WE)
add_custom_target(_pub_sub_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "pub_sub" "/datav/projects/ROS/demo3_publisher_subscriber/src/pub_sub/msg/Spacecraft.msg" ""
)
...
_generate_msg_cpp(pub_sub
  "/datav/projects/ROS/demo3_publisher_subscriber/src/pub_sub/msg/Spacecraft.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pub_sub)
  install(CODE "execute_process(COMMAND \"/datav/software/anaconda3/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/pub_sub\")")
  # install generated code
  install(
